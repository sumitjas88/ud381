...
public class SentenceWordCountTopology {
  ...
  /**
  * A bolt that split sentence into words
  **/
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("split-sentence-word", new SplitSentenceBolt(), 15).shuffleGrouping("sentence-spout");

    builder.setBolt("count-bolt", new CountBolt(), 15).fieldsGrouping("split-sentence-word", new Fields("sentence-word"));
